...
import { Plonge } from './../util/plonge';
    ...
    useEffect(() => {
        setInitialRecords(() => {
            return items.filter((item) => {
                return (
                    item.geoLocation.toLowerCase().includes(search.toLowerCase()) || item.date.toLowerCase().includes(search.toLowerCase()) || item.city.toLowerCase().includes(search.toLowerCase())
                );
            });
        });
    }, [search]);
                        ...
                        columns={[
                            {
                                accessor: 'Plonge',
                                sortable: true,
                                render: ({ id, city, date, depth, duration, geoLocation, species }) => (
                                    <NavLink to="/apps/diveShow" state={{ id: id, city: city, depth: depth, date: date, duration: duration, geoLocation: geoLocation, species: species }}>
